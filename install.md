# Platzi - FundamentosAL guide installation
...
activate platzi___fundamentosal
```
...
To move beyond notebook prototyping, all reusable code should go into the `platzi___fundamentosal/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `platzi___fundamentosal` folder and use the modules inside your notebooks :
...
```python
from platzi___fundamentosal.utils.paths import data_dir
data_dir()
```
